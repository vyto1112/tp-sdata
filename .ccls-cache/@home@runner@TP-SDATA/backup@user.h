...
//Method untuk mencetak invoice dalam bentuk "invoice.txt" dan mencatat data transaksi pada "data_transaksi.txt"
void User::invoice(){
  ...
  struk << "NIK    : " << dataKTP2.NIK << endl;
  struk << "Nama   : " << dataKTP2.nama << endl;
  struk << "Alamat : " << dataKTP2.alamat << endl;
  struk << "---------------------------------------------------" << endl;
  ...
  catat << "Transaksi pada tanggal " << tglb << " atas nama " << dataKTP2.nama << endl;
  catat << "---------------------------------------------------" << endl;
